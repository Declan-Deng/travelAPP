...
const routeDefinitions = [
  {
    ...
    note: "早出晚归效率最高",
    mapKicker: "一日路线",
    headline: "一日看见香港最经典的街巷、海景与天际线",
    lead:
      "从旺角和油麻地起步，顺着尖沙咀海滨切到中环和山顶，最后在铜锣湾收尾，适合第一次来香港时把最经典的城市表情先走一遍。",
  ...
  },
  {
    ...
    note: "把港岛、九龙和文化馆线拆开",
    mapKicker: "三日路线",
    headline: "三天把香港拆成港岛、西九龙和老九龙三层来走",
    lead:
      "第一天看港岛核心与港岛西，第二天把深水埗、油麻地、旺角和维港南岸连成老九龙线，第三天把上环和西九龙文化区留给节奏更慢的收尾。",
  ...
  },
  {
    ...
    note: "适合第一次长一点地待在香港",
    mapKicker: "五日路线",
    headline: "五天把街区、海湾、山海和离岛节奏都留出来",
    lead:
      "前两天解决九龙与港岛的城市密度，第三天给南区海湾，第四天拉到大屿山，第五天再回中环海滨和老建筑收尾，整趟会比短线从容很多。",
